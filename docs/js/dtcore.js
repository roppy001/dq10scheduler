...
var SEAL_DATA = [
  ...
  { title: '調査中4 トラ、ちゃがま', index: 20, page: 3, rarity: 1 },
  { title: '調査中5 テラシ、ヤドカシ、ホラー', index: 23, page: 3, rarity: 2 },
  { title: '調査中6 トラ、ちゃがま', index: 27, page: 3, rarity: 1 },
  { title: '調査中7 タコ、ヤドカシ', index: 29, page: 3, rarity: 1 },
  { title: '調査中8 もも、つっぱり、ちゃがま', index: 32, page: 3, rarity: 1 },
  { title: '調査中9 トラ、テラシ', index: 34, page: 3, rarity: 0 },
  { title: '調査中10 タコ、ヤドカシ、ホラー', index: 39, page: 3, rarity: 2 },
  { title: '調査中11 もも、ちゃがま、ホラー', index: 42, page: 3, rarity: 2 },
  { title: '調査中12 トラ、つっぱり、ヤドカシ', index: 44, page: 3, rarity: 1 },
  { title: '調査中13 タコ、つっぱり', index: 49, page: 3, rarity: 0 },
  { title: '調査中14 トラ、テラシ', index: 51, page: 3, rarity: 0 },
  { title: '調査中15 もも、テラシ、ヤドカシ、ホラー', index: 54, page: 3, rarity: 2 },
  ...
  { title: '調査中21 トラ、つっぱり、ヤドカシ', index: 76, page: 3, rarity: 1 },
  { title: '調査中22 タコ、ちゃがま', index: 81, page: 3, rarity: 1 },
  { title: '調査中23 もも', index: 86, page: 3, rarity: 0 },
  { title: '調査中24 トラ、つっぱり、ヤドカシ', index: 92, page: 3, rarity: 1 },
