...
var SEAL_DATA = [
  ...
  { title: '調査中2 テラシ', index: 10, page: 3, rarity: 0 },
  { title: '調査中3 つっぱり', index: 13, page: 3, rarity: 0 },
  { title: '調査中4 トラ', index: 20, page: 3, rarity: 0 },
  { title: '調査中5 ホラー', index: 23, page: 3, rarity: 2 },
  { title: '調査中6 トラ', index: 27, page: 3, rarity: 0 },
  { title: '調査中7 ヤドカシ', index: 29, page: 3, rarity: 1 },
  ...
  { title: '調査中12 ヤドカシ', index: 44, page: 3, rarity: 1 },
  { title: '調査中13 タコ', index: 49, page: 3, rarity: 0 },
