...
var SEAL_DATA = [
  ...
  { title: 'トラ、テラシ', index: 34, page: 3, rarity: 0 },
  { title: 'タコ、ヤドカシ、ホラー', index: 39, page: 3, rarity: 2 },
  ...
  { title: 'タコ、ヤドカシ、ホラー', index: 63, page: 3, rarity: 2 },
  { title: 'もも、ちゃがま', index: 65, page: 3, rarity: 1 },
  { title: 'タコ、テラシ', index: 71, page: 3, rarity: 0 },
  { title: 'トラ、つっぱり、ヤドカシ', index: 76, page: 3, rarity: 1 },
  { title: 'タコ、ちゃがま', index: 81, page: 3, rarity: 1 },
  { title: 'もも', index: 86, page: 3, rarity: 0 },
  { title: 'トラ、つっぱり、ヤドカシ', index: 92, page: 3, rarity: 1 },
